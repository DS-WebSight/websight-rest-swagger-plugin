...
Rest Swagger Plugin is a Maven plugin for generating Rest API specification by scanning WebSight Rest actions in modules the plugin is enabled for.
...
Dynamic Solutions WebSight (Rest Swagger Plugin) - Rest Swagger Plugin
